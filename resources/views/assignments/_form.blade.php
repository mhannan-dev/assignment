...
<div class="mb-3">
    <div class="form-group">
        ...
        <select class="form-control {{ $errors->has('class_model_id') ? 'is-invalid' : '' }}" name="class_model_id" required>
...
<div class="mb-3">
    <div class="form-group">
        ...
        <select name="section_id" class="form-control {{ $errors->has('section_id') ? 'is-invalid' : '' }}" required>
           <option value="">-- @lang('Select') --</option>
...
<div class="mb-3">
    <div class="form-group">
        ...
        <select class="form-control {{ $errors->has('subject_id') ? 'is-invalid' : '' }}" name="subject_id" required>
           <option value="">-- @lang('Select') --</option>
